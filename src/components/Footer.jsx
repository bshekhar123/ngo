...
const Footer = () => {
    ...
    return (
        <>
            <div className="w-full py-16 pb-2  bg-gray-800 ">
                <div className="max-w-[1240px] mx-auto  flex flex-col px-14">
                    <div className="sm:flex   justify-between items-center">
                        <img className="p-7 m-auto" width="200px" src={logo} />
                        ...
                        <div className="flex justify-between lg:ml-14 my-6 justify-content w-full   sm:max-w-[200px]   ">
