        ...
        <>
            <div className="max-w-[1240px] text-center  mx-auto py-20" id="object">
                ...
                <div className="flex flex-col float-left p-14 space-y-16 > * + *">
                    ...
                    <p><span className="text-black text-2xl">4.</span> Establishment, conduct, maintenance of clinical laboratories, hospitals, nursing
                    ...
                    <p><span className="text-black text-2xl">5.</span>.Providing financial assistance for children education, welfare and their skills
