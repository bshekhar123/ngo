        ...
        <>
            <div id="body" className="">
                ...
                <div className="absolute top-0 h-full w-full flex flex-col justify-center text-center text-white p-4 text-4xl">
                    ...
                    <div className="flex justify-between items-center  text-center bg-orange-500 max-w-[300px] mx-auto w-full text-xl py-3  rounded-2xl   hover:bg-gradient-to-r from-[#f5493d] to-[#fa5407]  transition duration-150 ease-out hover:ease-in  hover:cursor-pointer ">
