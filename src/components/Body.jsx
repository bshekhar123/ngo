    ...
    return (
        <>
            <div id="body" className="">
                ...
                <div className="w-full h-screen absolute top-0 bg-black/70"></div>
                <div className="absolute top-0 h-full w-full flex flex-col justify-center text-center text-white p-4 text-4xl">
                    <h1 className="textc font-bold  text-orange-500">Swami Vivekananda Social Development And Charitable Trust </h1>
